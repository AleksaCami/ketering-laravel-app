...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Dodaj novog klijenta') }}</div>

                    <div class="card-body">
                        <form method="POST" action="/klijenti/store">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="broj_telefona" type="text" class="form-control @error('broj_telefona') is-invalid @enderror" name="broj_telefona" required autocomplete="broj_telefona">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="kontakt_osoba" type="text" class="form-control @error('kontakt_osoba') is-invalid @enderror" name="kontakt_osoba" required autocomplete="kontakt_osoba">
